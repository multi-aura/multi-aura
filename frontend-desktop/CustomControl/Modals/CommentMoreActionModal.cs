...
{
    public partial class CommentMoreActionModal : Form
    {
        ...
        {
            if (IsOwner && !string.IsNullOrEmpty(CommentId))
            {
                ...
                if (confirmResult == DialogResult.Yes)
                {
                    ...
                    try
                    {
                        bool result = await postDataProvider.DeleteCommentAsync(CommentId);
