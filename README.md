...
- Tạo ra một không gian kết nối mọi người mà không có rào cản về ngôn ngữ hay khả năng đọc, thông qua việc chuyển đổi văn bảnviết

   6 Khi hoàn thành tạo bài viết hệ thống sẽ lưu và hiển thị lên trang mới nhất New Feed.
